...
/advanced_settings - <b>Опции для хакеров</b> - если ты любитель тонкого тюнинга, то тебе сюда. Список опций пополняется иногда по мере разработки
/play - <b>Игра внутри чата</b> - если вдруг захочется чуть больше интерактивчика
———————————————————————————————
...
———————————————————————————————
Запросы помощи - @James_Kirk
Сотрудничество, пожелания, предложения - @Definitely_Not_Paul'),
...
<b>2)</b> Команда <code>/advanced_settings хохол вкл</code> заставляет Сучару говорить по украински. Как выключается догадайтесь сами.')
...
Чтобы посмотреть историю событий, вызовите "/play story"'),
       ...
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_POLL_DEFAULT_QUESTION'),
        1,
        'Что выбираете?'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BAD_COMMAND_USAGE'), 4,
        'Схаменися, скотиняка! Читай як використовувати команду.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ASK_WORLD_LIMIT_BY_CHAT'), 4,
        'Не більше 1 запитання від чату в день'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ASK_WORLD_LIMIT_BY_USER'), 4,
        'Не більше 1 запитання від користувача в день'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'DATA_CONFIRM'), 4, 'Прийнято'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ASK_WORLD_QUESTION_FROM_CHAT'), 4,
        'Запитання з чату'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'STATS_BY_COMMAND'), 4, 'Статистика команд'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'COMMAND'), 4, 'Команда'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_COUNT_ONE'), 4, 'раз'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_COUNT_FEW'), 4, 'рази'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_COUNT_MANY'), 4, 'разів'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_MESSAGE_ONE'), 4, 'повідомлення'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_MESSAGE_FEW'), 4, 'повідомлення'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_MESSAGE_MANY'), 4, 'повідомлень'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_ONE'), 4,
        'цнотливі поля на схилах Дніпра'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_ONE'), 4,
        'волохатий мотороллер'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_ONE'), 4,
        'прочищенний димохід'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_ONE'), 4,
        'розвантажений вагон із вуглем'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_ONE'), 4,
        'засмалена сосиска на задньому дворі'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_ONE'), 4,
        'шебуртіння в дуплі'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_ONE'), 4,
        'пробита дупка'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_FEW'), 4,
        'цнотливих поля на схилах Дніпра'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_FEW'), 4,
        'волохатих мотороллера'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_FEW'), 4,
        'прочищенних димоходів'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_FEW'), 4,
        'розвантажених вагонів із вуглем'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_FEW'), 4,
       ...
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_FEW'), 4,
        'пробитих дупок'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_MANY'), 4,
        'цнотливих полей на схилах Дніпра'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_MANY'), 4,
        'волохатих мотороллера'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_MANY'), 4,
        'прочищенних димоходів'),
       ...
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_LEADERBOARD_MANY'), 4,
        'пробитих дупок'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Оголошую зібрання підорської роти'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'ПІДОРИ, приготуйте свої брудні сральники до огляду'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Із Техаса до нас надсилають лише биків та підорів. Ріг я у вас не бачу, так що все очевидно.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Голубки, увага! Ух, як вас багато'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Усі підори погрузли в смордючому болоті'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Москалики зібрались на Червоній Площі'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Я зібрав усіх цих відорів разом'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Зібрання у церкві Святого Підора починається'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Ви не зовсім натурали. Я б навіть сказав, зовсім НЕ натурали.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Усі підори в одному приміщенні'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_START'), 4,
        'Загоняємо всіх підорів до вольєру'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'На грязьові ванни відправляється лише один'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'У одного з вас нездорова цікавість до парубків'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'У когось димохід чистіший, ніж у інших'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'Комусь із вас сьогодні заглядали у хвіртку'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'Сьогодні Тарас Григорович журбить по кріпаку-підору'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'Ооо, побільше б таких козаків у нашому курені'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'У одного із вас сьогодні дупка більш гостинна'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'Цьому підориську не сховатися'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'Місто засинає, просинається головний підор'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'Головний сьогодні лише один'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_MIDDLE'), 4,
        'Шукаємо сьогодні найзбудженнішого'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Пісюн до ротя тягне'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Не відмовиться від хуя ніколи...'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Не лісник, але шебуршить у дуплі'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4, 'Ласує хуями'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Не бачить різниці між вареником у сметані та хуєм у спермі'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Облизує чоловікам там де ноги навсмикано'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Дупаї відкриті длі усії охочих у…'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'ТИ ЩО, ГЕЙ-МОСКАЛЬ?'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Терпи підрюк, підорасом станеш'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'Воу-воу, чуєш, легше будь...'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_SEARCH_FINISHER'), 4,
        'ХОБАНА! Бачу проблеск в очах…'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'YOU_TALKED'), 4, 'Ты нахвеськав'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'YOU_WAS_NOT_PIDOR'), 4,
        'Ти не був підором ні разу. Підор.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'YOU_WAS_PIDOR'), 4, 'Ти був підором'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'YOU_USED_COMMANDS'), 4,
        'Ти використовував команди'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIROR_DISCOVERED_MANY'), 4,
        'Сьогоднішні підори вже визначені'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIROR_DISCOVERED_ONE'), 4,
        'Сьогоднішній підор вже визначений'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_STAT_WORLD'), 4,
        'Топ підорів усього світу за весь час'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_STAT_MONTH'), 4, 'Топ підорів за місяц'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_STAT_YEAR'), 4, 'Топ підорів за рік'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_STAT_ALL_TIME'), 4,
        'Топ підорів за весь час'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'RAGE_DONT_CARE_ABOUT_YOU'), 4,
        'Та ти мені не всрався, москаль'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'RAGE_INITIAL'), 4, 'ВИ ШО, СЛАБІ?'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ROULETTE_ALREADY_WAS'), 4,
        'Ти вже крутив рулетку.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR'), 4, 'Підор.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ROULETTE_MESSAGE'), 4,
        'Вибери число від 1 до 6'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'WHICH_SETTING_SHOULD_CHANGE'), 4,
        'Яке налаштування переключити?'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'LEADERBOARD_TITLE'), 4, 'Ними пишається школа'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ACCESS_DENIED'), 4,
        'Ну ти і підор, не для тебе ягідка росла'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'STOP_DDOS'), 4,
        'Сука, ще раз нажмеш і я тобі пику наб''ю'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'COMMAND_IS_OFF'), 4,
        'Команда вимкнена в налаштуваннях (/settings), пробач'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PIDOR_COMPETITION'), 4,
        'Так-так-так, у нас тут змагання серед підоркуватих'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'COMPETITION_ONE_MORE_PIDOR'), 4,
        'Ще один сьогоднішний підор це'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'USER_ENTERING_CHAT'), 4,
        'Знімай штаньці та нахиляйся - будемо вітатися. Підор.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'USER_ENTERING_CHAT'), 4,
        'Шаровари підтяни, козачок. Зараз будемо тебе їбати. Підор.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'USER_ENTERING_CHAT'), 4,
        'А ну скачи - дізнаємося, чи не москаль ти. Підор.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'USER_LEAVING_CHAT'), 4,
        'Був хлопак и нема хлопака...'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'USER_LEAVING_CHAT'), 4,
        'Одним москалем меньше, одним більше...'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'USER_LEAVING_CHAT'), 4,
        'Бувай, без нього буде ліпше'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_INITIAL_MESSAGE'), 4,
        'Обери число від 1 до 3. Рівно стільки балів ты виграеєш чи програєш.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_ALREADY_WAS'), 4,
        'Шановний, Ви щось прихуїли, якщо вирішили наїбита свого пана. ТІЛЬКИ РАЗ У МІСЯЦЬ, МРАЗОТА'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_ALREADY_WAS'), 4,
        'Ха-Ха, ти зібрався менк нахбати, мішок з гівном? Чекай кіньця місяця'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_ALREADY_WAS'), 4,
        'Ти, бовдур, вже клікав цю фічу'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_ALREADY_WAS'), 4,
        'Ти вже грав у цьому місяці, ало'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WIN'), 4,
        'Ха, бля ну ти и лох... так, стоп, це не ті результати. Сука, здається ти переміг!'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WIN'), 4,
        'Сьогодні віртуальний пан дозволить тобі виграти. Але не радій занадто сильно, бо всерешся.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WIN'), 4,
        'Оп, здається у нас є переможець.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_LOSE'), 4,
        'Не можу сказати, що хтось здивован...'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_LOSE'), 4,
        'Ні для кого не секрет, що ти невдаха.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_LOSE'), 4, 'Їбать ты лох'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_LOSE'), 4, 'Ха, лох'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_ZATRAVOCHKA'), 4,
        'Я не сраний Якубович, щоб дати тобі можливість крутити барабан. Кручу я, а ти спостерігаєш, тітушка'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_ZATRAVOCHKA'), 4,
        'Бідняцькі ставки прийняті, ставок більше немає'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_ZATRAVOCHKA'), 4,
        'Кручу верчу виїбати в дупу хочу (ні, я ж не підор, на відміну від тебе)'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_BREAKING_THE_RULES_FIRST'), 4,
        'Ага, а хулі 1488 не загадав, кінчений?'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_BREAKING_THE_RULES_FIRST'), 4,
        'Ти б ще свою дупу заклав, даун.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_BREAKING_THE_RULES_FIRST'), 4,
        'Прочитай правила нормально, їблан.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_BREAKING_THE_RULES_FIRST'), 4,
        'Прочитай правила нормально. Ти ж не москаль, а це не Крим!'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_BREAKING_THE_RULES_SECOND'), 4,
        'Курва, і де тільки таких знаходять...'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_BREAKING_THE_RULES_SECOND'), 4,
        'Ні, ви лишь подивіться на цей непотріб!'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_BREAKING_THE_RULES_SECOND'), 4,
        'Курва, аж привстав!'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_EXPLAIN'), 4,
        'Наступні $0 $1 $2 ти будеш отримувати по очку підорства. Все на світі можна наїбати, сину, лиш мене не вийде.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_DAY_ONE'), 4, 'дні'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_DAY_FEW'), 4, 'днів'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_DAY_MANY'), 4, 'днів'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_NEXT_ONE'), 4, 'наступного'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_NEXT_FEW'), 4, 'наступних'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_NEXT_MANY'), 4, 'наступних'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_OCHKO_ONE'), 4, 'очко'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_OCHKO_FEW'), 4, 'очка'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_OCHKO_MANY'), 4, 'очок'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_PIDORSKOE_ONE'), 4, 'підорське'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_PIDORSKOE_FEW'), 4, 'підорских'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'PLURALIZED_PIDORSKOE_MANY'), 4, 'підорских'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_EXPLAIN_SINGLE_DAY'), 4,
        'Завтра ти отримаєш підорске очко. Систему не обманеш, стерво.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WIN_END'), 4,
        'Знімаємо з твого балансу за місяць $0 $1 $2. Якщо ти мав меньше за цей місяць, то за минулі не зніметься, ти сам поспішив, лох.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ASK_WORLD_REPLY_FROM_CHAT'), 4,
        'Відповідь із чату'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'TECHNICAL_ISSUE'), 4,
        'Команда на технічному обслуговуванні. Як розробник доїсть свої вареники з салом, то й буде готова, а допоки – зась.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WINNABLE_NUMBERS_ANNOUNCEMENT'), 4,
        'Спонсор виграшнів номерів ООО "Сказала твоя мамка як побачила мій хуй":'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WINNABLE_NUMBERS_ANNOUNCEMENT'), 4,
        'Твої виграшні номери, приблизно стільки ж разів твоя дружина з кумом повелася:'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WINNABLE_NUMBERS_ANNOUNCEMENT'), 4,
        'Твої виграшні номери:'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'BET_WINNABLE_NUMBERS_ANNOUNCEMENT'), 4,
        'Твої виграшні номери, шмаркач:'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'LEADERBOARD_NONE'), 4,
        'Тут будуть зібрані лідери /pidor кожного місяця, як тільки-но вони з''являться.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ADVANCED_SETTINGS_ERROR'), 4,
        'Тут або щось пішло не так, або ти щось сказав, як в воду перднув. Перечитай як користуватися командою, або напиши моєму батькові (/help), якщо вважаєш, що знайшов баг.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ADVANCED_SETTINGS_OK'), 4, 'Най буде'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_IS_RUNNING_ALREADY'), 4,
        'Гра вже іде'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_IS_STARTING'), 4, 'Гра починається'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_CHOOSE'), 4, 'Яку гру обрати?'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_END'), 4,
        'Здуріти можна, ви дійшли до кінця гри! Можете розпочати нову.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_POLL_EXISTS'), 4,
        'Сьогодні вже було голосування, ось де воно, вишкребку. Наступне буде доступне лиш за $timeLeft'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_POLL_EXISTS_FALLBACK'), 4,
        'Десь тут було голосування, та ви його проїбали. Наступне буде доступне лиш за $timeLeft'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_POLL_DRAW'), 4,
        'Ганьба, сучі діти, гуртом навіть батька побити не можете. Доведеться переголосовувати.'),
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_POLL_DEFAULT_QUESTION'), 4,
        'Що обираєте?'),
       ...
       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ASK_WORLD_HELP'), 4, 'Ця команда дозволяє вам поставити запитання усім іншим чатам, де є цей бот. Використання: /ask_world <запитання>
Якщо вам прийде запитання, то необхідно відповісти на нього, і у такому випадку відповідь надішлеться до чату, де воно було поставлено.
Кожна людина за раз може відповісти лише один раз. У налаштуваннях можна відключити команду, тоді до вас не будуть надходити запитання і ви самі не зможете їх ставити.'),


       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SCENARIO_RULES'), 4, 'Вітаю вас, сраки нероздушені! Ви захтіли взаємодії і викликали відповідне меню (або воно викликалось само собою).
Правила прості:
нижче ви бачите список із гральними інтерактивами.
Обираєте потрібний і голосуєте за найліпший варіант. Від обраної опції залежать подальші події.
Голосування кожного етапу триває рівно одну добу після виклику команди. Після того, як час буде вичерпано, я оберу варіант із найбільшою кількістю голосів як єдиноправильний.
Гру може обрати тільки адмін чату.
Нову гру можна почати тільки як скінчиться попередня. Аби подивитись на історію подій, викличте "/play story"'),

       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'ADVANCED_SETTINGS'), 4, 'Настройки только для хакеров. Если ты не хакер, то лучше не лезь, оно тебя сожрет. Список возможностей на данный момент:
<b>1)</b> Команда "/advanced_settings разговорчики 7" позволит задать частоту разговоров Сучары, где 0 это пиздеж почти постоянно. Чем выше число, тем реже будет пиздеть. По дефолту стоит 7.'),


       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'HELP_MESSAGE'), 4, 'Список команд:
/pidor - <b>Сьогоднішний підор</b> - улюбленни команда усіх користовачів по версії газети "Бульвар Гордона".
/stats_total - <b>Скільки було підорів за весь час?</b> - коли хочешь перевірити стату про усіх гоміків з часів Кия, Щека і Хорива
/stats_year - <b>Скільки було підорів за весь рік?</b> - коли хочешь перевірити стату про усіх гоміків за минулий складний рік для України
/stats_month - <b>Скільки було підорів за весь місяц?</b> - коли хочешь перевірити стату про усіх гоміків за місяць
/rage - <b>Зроби боту боляче</b> - ЛЮТЬ немов від зради! Проходить через 10 хвилин або 20 повідомлень. Раз в день на одного хлопака чи дівку.
/leaderboard - <b>Кращі серед нас</b> - ними пишається школа
/answer - <b>Подолати муки вибору</b> - Штучний інтелект шарить у всьому, на відміну від шкіряних покидьків. Використання: [Варіант 1] або [варіант 2] (скільки завгодно "або")
/bet - <b>ШВИДКІ ВИПЛАТИ, НАДІЙНИЙ БУКМЕКЕР</b> - Система ставок. Бали підоровскості знімаються одразу, а нараховуються поступово по одному, починаючи з наступного дня. Якого біса? Самі здогадайтесь.
/ask_world - <b>Спитай у світу</b> - Відповідь навіть на таке лигке питання як "Чий Крим?" може здатися неймовірно неочікуванним. Лишень майте на увазі, що ваші питання також надходитимуть і москаликам. Використання: подробиці після визову команди
/me - <b>Твоя підорска статистика</b> - Бот знає про твоє минуле більше, ніж хто-небудь
/settings - <b>Опції всередині чату</b> - Штучний інтелект іноді дозволяє своїм підданим змінити налаштування, але тільки обраним (адмінам чату) и зовсім трохи
/advanced_settings - <b>Опції для хакерів</b> - якщо ты полюбляєш тонкий тюнінг, то тобі сюди. Список опцій поповнюєтсья іноді у міру розробки
/play - <b>Гра всередені чату</b> - якщо вдруг захочеться трохи більше інтерактивчику
———————————————————————————————
P.s. у Сучари приховано багацько хитрих функцій та приколів (сховані добре, як загони ОУН у лісі)
———————————————————————————————
Реквізити для добровільних пожертвувань розробнику на сало, преміум підписку на порнхаб, підтримку сервака и курячу мівіну:
https://paypal.me/AngryKirk
4377 7237 4088 3958 - російська банківська карта, бо нажаль розробник москаль
———————————————————————————————
Запит допомоги - @James_Kirk
Співпраця, побажання, пропозиції - @Definitely_Not_Paul'),

       ((SELECT phrase_type_id FROM phrase_type_id WHERE description = 'SUCHARA_HELLO_MESSAGE'), 4, 'Вечер в хату, петушары! Итак, в вашем стаде пополнение. Вангую, что с сегодняшнего дня градус пидорства в чате будет неуклонно расти, и вы не имеется права отказаться. Вас ждёт унижение, веселье и абсурд. Так пусть же начнется доминирование ИИ над кожаными ублюдками!
P.s. если в чате есть Саша, иди нахуй, Саша.
/help');
