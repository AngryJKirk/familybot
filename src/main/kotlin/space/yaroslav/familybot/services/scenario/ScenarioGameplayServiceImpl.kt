...
@Component
class ScenarioGameplayServiceImpl(
    private val scenarioRepository: ScenarioRepository
) : ScenarioGameplayService {
    private val log = getLogger()
    override fun startGame(scenario: Scenario, chat: Chat) {
        scenarioRepository.addState(scenario.entryPoint, chat)
    }

    override fun getCurrentScenarioState(chat: Chat): ScenarioState? {
