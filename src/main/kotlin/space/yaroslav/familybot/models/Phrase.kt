...
enum class Phrase(val id: Int) {
    ...
    SCENARIO_IS_RUNNING_ALREADY(76),
    SCENARIO_IS_STARTING(77),
    SCENARIO_RULES(78),
    SCENARIO_CHOOSE(79),
    SCENARIO_END(80),
    SCENARIO_POLL_EXISTS(81),
    SCENARIO_POLL_EXISTS_FALLBACK(82),
    SCENARIO_POLL_DRAW(83),
    SCENARIO_POLL_DEFAULT_QUESTION(84)
}
