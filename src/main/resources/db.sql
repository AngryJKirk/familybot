...
INSERT INTO pidor_leaderboard_dictionary (message, range_from, range_to) VALUES
  ('пробитая жёпка', 1, 1),
  ('пробитых жёпки', 2, 4),
  ('пробитых жёпок', 5, 20),
  ('пробитая жёпка', 21, 21),
  ('пробитых жёпки', 22, 24),
  ('пробитых жёпок', 25, 30),
  ('пробитая жёпка', 31, 31),
  ('пробитых жёпки', 32, 34);

INSERT INTO pidor_leaderboard_dictionary (message, range_from, range_to) VALUES
  ('шебуршание в дупле', 1, 1),
  ('шебуршания в дупле', 2, 4),
  ('шебуршаний в дупле', 5, 20),
  ('шебуршание в дупле', 21, 21),
  ('шебуршания в дупле', 22, 24),
  ('шебуршаний в дупле', 25, 30),
  ('шебуршание в дупле', 31, 31),
  ('шебуршания в дупле', 32, 34);

INSERT INTO pidor_leaderboard_dictionary (message, range_from, range_to) VALUES
  ('прожаренная сосиска на заднем дворе', 1, 1),
  ('прожаренные сосиски на заднем дворе', 2, 4),
  ('прожаренных сосисок на заднем дворе', 5, 20),
  ('прожаренная сосиска на заднем дворе', 21, 21),
  ('прожаренные сосиски на заднем дворе', 22, 24),
  ('прожаренных сосисок на заднем дворе', 25, 30),
  ('прожаренная сосиска на заднем дворе', 31, 31),
  ('прожаренные сосиски на заднем дворе', 32, 34);


INSERT INTO pidor_leaderboard_dictionary (message, range_from, range_to) VALUES
  ('разгруженный вагон с углём', 1, 1),
  ('разгруженных вагона с углём', 2, 4),
  ('разгруженных вагонов с углём', 5, 20),
  ('разгруженный вагон с углём', 21, 21),
  ('разгруженных вагона с углём', 22, 24),
  ('разгруженных вагонов с углём', 25, 30),
  ('разгруженный вагон с углём', 31, 31),
  ('разгруженных вагонов с углём', 32, 34);

INSERT INTO pidor_leaderboard_dictionary (message, range_from, range_to) VALUES
  ('прочищенный дымоход', 1, 1),
  ('прочищенных дымохода', 2, 4),
  ('прочищенных дымоходов', 5, 20),
  ('прочищенный дымоход', 21, 21),
  ('прочищенных дымохода', 22, 24),
  ('прочищенных дымоходов', 25, 30),
  ('прочищенный дымоход', 31, 31),
  ('прочищенных дымохода', 32, 34);


INSERT INTO pidor_leaderboard_dictionary (message, range_from, range_to) VALUES
  ('волосатый мотороллер', 1, 1),
  ('волосатых мотороллера', 2, 4),
  ('волосатых мотороллеров', 5, 20),
  ('волосатый мотороллер', 21, 21),
  ('волосатых мотороллера', 22, 24),
  ('волосатых мотороллеров', 25, 30),
  ('волосатый мотороллер', 31, 31),
  ('волосатых мотороллера', 32, 34);

INSERT INTO pidor_leaderboard_dictionary (message, range_from, range_to) VALUES
  ('девственный лес Камбоджи', 1, 1),
  ('девственных леса Камбоджи', 2, 4),
  ('девственных лесов Камбоджи', 5, 20),
  ('девственный лес Камбоджи', 21, 21),
  ('девственных леса Камбоджи', 22, 24),
